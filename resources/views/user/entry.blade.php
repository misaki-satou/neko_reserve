        ...
        <form method="POST" action="{{ route('user.confirm') }}">
          ...
          <div class="form-row mb-4 justify-content-center">
            <div class="form-group col-md-4">
              <label for="family-name">飼い主様のお名前（姓）<span class="badge badge-danger">必須</span></label>
              <input type="text" class="form-control" name="family-name" value="{{ old('family-name') }}" autocomplete="family-name">
            </div>
            <div class="form-group col-md-4">
              <label for="given-name">飼い主様のお名前（名）<span class="badge badge-danger">必須</span></label>
          ...
          <div class="form-row mb-4 justify-content-center">
            <div class="form-group col-md-4">
              <label for="cat-name">ねこのお名前<span class="badge badge-danger">必須</span></label>
